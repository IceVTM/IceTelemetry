...
using ICE.VTC.TELEMETRY.Controllers;
using ICE.VTC.TELEMETRY.Data;
using ICE.VTC.TELEMETRY.Helpers;
using ICE.VTC.TELEMETRY.Setup;
...
namespace ICE.VTC.TELEMETRY
{
    public partial class MainForm : Form
    {
        ...
        string BroadcastUserPassword = Convert.ToBase64String(
            Utf8.GetBytes(Properties.Settings.Default.driverToken.ToString() ?? ""));
        ...
        {
            driverTokenTextBox.Text = Properties.Settings.Default.driverToken.ToString();
        ...
        void MainForm_Resize(object sender, EventArgs e)
        {
            ...
            {
                trayIcon.ShowBalloonTip(1000, @"Ice Telemetry", @"Double-click to restore.", ToolTipIcon.Info);
        ...
        {
            Properties.Settings.Default.driverToken = driverTokenTextBox.Text;
            Properties.Settings.Default.Save();
            MessageBox.Show(this, "Ice Telemetry will now close. To apply any changes and continue tracking loads please re-open Ice Telemetry.", @"Done", MessageBoxButtons.OK, MessageBoxIcon.Information);
            Close();
        }

        private void label3_Click(object sender, EventArgs e)
        {
            Process.Start("http://62.31.252.107/");
        }
    }
}
